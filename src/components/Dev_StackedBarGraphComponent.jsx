...
class BarGraph extends React.Component {
  ...
  drawBarGraph() {
    ...
    filteredData.forEach(element => {
      ...
      rainfall[year][location] = rainfall[year][location] + element[rainfallIndex];
    });
    ...
    graph.append("g")
		...
		.attr("class", "y-axis")
   graph
      .selectAll('.x-axis').transition().duration(100)
      ...
      // .text('Annual Rainfall (mm)');
        ...
        graph.selectAll(".y-axis").transition().duration(100)
        ...
        .attr("y", 0)
        .attr("height", 0)
        .attr("width", function(d, i) { return xScale(annual_rainfall[i]); }) 
        .attr('fill','#3498DB')
